...
public class TileFactory {
    ...
    public static List<Tile> createTiles() {
        return  new ArrayList<>(List.of(
                ...
                new Street("Musk’s Mars", 27, 260, 130, 3, Colors.YELLOW, List.of(22, 110, 330, 800, 975, 1150, 150)),
                new Property("Water Works", 28, 150, 75, 50, 2, Colors.WHITE),
                new Street("Mark’s Metaverse", 29, 280, 140, 3, Colors.YELLOW, List.of(24, 120, 360, 850, 1025, 1200, 150)),
